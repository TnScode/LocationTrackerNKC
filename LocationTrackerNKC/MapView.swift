...
struct MapView: View {
    ...
    private let locations: [(name: String, coordinate: CLLocationCoordinate2D)] = [
        ...
        ("Ravenwood Elementary", CLLocationCoordinate2D(latitude: 39.199684, longitude: -94.519996)),
        ...
        ("Northgate Middle School", CLLocationCoordinate2D(latitude: 39.180699, longitude: -94.554549)),
